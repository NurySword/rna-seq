...
pdf(file="/home/nury/workspace/rnaseq/de/ballgown/ref_only/Tutorial_Part3_Supplementary_R_output.pdf")
...
gene_expression[1:3, c("FPKM.NORMAL_Rep1","FPKM.NORMAL_Rep2","FPKM.NORMAL_Rep3","FPKM.TUMOR_Rep3")]
